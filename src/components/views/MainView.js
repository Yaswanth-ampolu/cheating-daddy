...
export class MainView extends LitElement {
    ...
    async _loadFromStorage() {
        try {
            ...
            this._azureApiKey = (await cheatingDaddy.storage.getAzureApiKey().catch(() => '')) || '';
    ...
    async _saveHostedProvider(val) {
        this._hostedProvider = val;
        this._keyError = false;
        await cheatingDaddy.storage.updatePreference('hostedProvider', val);
        this.requestUpdate();
    }
    ...
    async _saveAzureResourceOrEndpoint(val) {
